...
public class CryptoHelper {
    ...
    *            if encryption fails
    */
   public byte[] decryptSymmetric(KeyParameter key, byte[] nonce, byte[] cipherText) 
         throws CryptoException {
    ...
    *           alias of private signing key to use
   ...
   public EcdsaP256SignatureWrapper computeSignature(
      ...
      return cryptoProvider.getECDSAProvider().computeSignature(toBeSignedDataBytes, signingCertificateBytes,
         signingPrivateKey);
   }
   ...
   public boolean verifySignature(
      ...
      EcdsaP256SignatureWrapper signature) throws CryptoException {
      return toBeSignedDataBytes != null ? cryptoProvider.getECDSAProvider().verifySignature(toBeSignedDataBytes,
         signingCertificateBytes, signingPublicKey, signature) : false;
   }
}
