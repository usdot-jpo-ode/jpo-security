...
public class CryptoHelperTest {
	...
	@Test
	public void testSigner() throws CryptoException, DecoderException {
		CryptoProvider provider = new CryptoProvider();
		...
		EcdsaP256SignatureWrapper signature = helper.computeSignature(message, dummySignerCertBytes, (ECPrivateKeyParameters)keyPair.getPrivate());
		...
		EcdsaP256SignatureWrapper signature2 = EcdsaP256SignatureWrapper.decode(encodedSignature, provider.getSigner());
